...
library(wapoR)
```
From there it is quite straight forward to query available collections. Note, that
...
together with he collection we wish to query.
...
WaPOR products since most of them were rescaled in order to reduce file size. 
